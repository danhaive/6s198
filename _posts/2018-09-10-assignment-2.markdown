...
![](({{ site.baseurl }}/assets/assignment-2/nan_1_2_4.PNG)
...
![](({{ site.baseurl }}/assets/assignment-2/3_1_1.PNG)
...
![](({{ site.baseurl }}/assets/assignment-2/3_1_2.PNG)
...
* Total time: 27.3 sec.
![](({{ site.baseurl }}/assets/assignment-2/accuracy_4_2_1.PNG)
#### Model 2: Top Layer with 20 HUs and Second Layer with 100 HUs
* Testing Accuracy: 90.6%
* Examples/sec: 525
* Examples trained: 28736
* Total time: 57.2 sec.
![](({{ site.baseurl }}/assets/assignment-2/accuracy_4_2_2.PNG)
